        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I build full-stack web applications, from Java-based backend
                services and REST APIs to responsive React.js interfaces
                backed by well-designed MySQL databases.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Alongside development, I validate what I build — functional,
                regression, and integration testing, backed by SQL
                validation and a solid Git workflow.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
